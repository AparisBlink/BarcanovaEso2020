...
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    { name: 'Título 4', element: 'h4', attributes: { 'class': 'bck-title bck-title6'} },
    { name: 'Título 5', element: 'h4', attributes: { 'class': 'bck-title bck-title7'} },
    { name: 'Título 6 Subrayado', element: 'h4', attributes: { 'class': 'bck-title bck-title8'} },
    { name: 'Título 7 Titulo pequeño', element: 'h4', attributes: { 'class': 'bck-title bck-title9'} },

    { name: 'Énfasis 1 Fondo color', element: 'span', attributes: { 'class': 'bck-enfasis-1'} },
    { name: 'Énfasis 2 Tipografía PT Sans Narrow', element: 'span', attributes: { 'class': 'bck-enfasis-2'} },
    { name: 'Énfasis 3 Tipografía Pangolin', element: 'span', attributes: { 'class': 'bck-enfasis-3'} },
    { name: 'Énfasis 4 Tipografía Roboto Slab', element: 'span', attributes: { 'class': 'bck-enfasis-4'} },
    { name: 'Énfasis 5 Tipografía Montserrat Extra Bold', element: 'span', attributes: { 'class': 'bck-enfasis-5'} },
    { name: 'Énfasis 6 Numeración', element: 'span', attributes: { 'class': 'bck-enfasis-6'} },
    { name: 'Énfasis 7 Fondo Mates Naranja', element: 'span', attributes: { 'class': 'bck-enfasis-7'} },
    { name: 'Énfasis 8 Fondo Mates Azul', element: 'span', attributes: { 'class': 'bck-enfasis-8'} },
    { name: 'Énfasis 9 Amarillo Llengua', element: 'span', attributes: { 'class': 'bck-enfasis-9'} },
    ...
    { name: 'Énfasis 15 Letra a 16px', element: 'span', attributes: { 'class': 'bck-enfasis-15'} },
      ...
      {name: 'Caja 1 Fondo color', type: 'widget', widget: 'blink_box', attributes: {'class': 'box-1'}},
      {name: 'Caja 2 Sabias que...', type: 'widget', widget: 'blink_box', attributes: {'class': 'box-2'}},
      {name: 'Caja 3 Vocabulario', type: 'widget', widget: 'blink_box', attributes: {'class': 'box-3'}},
      {name: 'Caja 4 Recuerda', type: 'widget', widget: 'blink_box', attributes: {'class': 'box-4'}},
      {name: 'Caja 5 Lápiz amarillo', type: 'widget', widget: 'blink_box', attributes: {'class': 'box-5'}},
      {name: 'Caja 6 Trama gris', type: 'widget', widget: 'blink_box', attributes: {'class': 'box-6'}},
      {name: 'Caja 7 Borde naranja', type: 'widget', widget: 'blink_box', attributes: {'class': 'box-7'}},
      {name: 'Caja 8 Borde color automático', type: 'widget', widget: 'blink_box', attributes: {'class': 'box-8'}},
      {name: 'Caja 9 Estrella roja', type: 'widget', widget: 'blink_box', attributes: {'class': 'box-9'}},
