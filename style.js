...
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    { name: 'Icono Ordenador Naranja', element: 'span', attributes: { 'class': 'icon icon-ordenador-naranja'} },
      ...
      {name: 'Caja 01 Fondo color', type: 'widget', widget: 'blink_box', attributes: {'class': 'box1'}},
      {name: 'Caja 02 Sabias que...', type: 'widget', widget: 'blink_box', attributes: {'class': 'box2'}},
      {name: 'Caja 03 Vocabulario', type: 'widget', widget: 'blink_box', attributes: {'class': 'box3'}},
      {name: 'Caja 04 Recuerda', type: 'widget', widget: 'blink_box', attributes: {'class': 'box4'}},
      {name: 'Caja 05 Lápiz amarillo', type: 'widget', widget: 'blink_box', attributes: {'class': 'box5'}},
      {name: 'Caja 06 Trama gris', type: 'widget', widget: 'blink_box', attributes: {'class': 'box6'}},
      {name: 'Caja 07 Borde naranja', type: 'widget', widget: 'blink_box', attributes: {'class': 'box7'}},
      {name: 'Caja 08 Borde color automático', type: 'widget', widget: 'blink_box', attributes: {'class': 'box8'}},
      {name: 'Caja 09 Estrella roja', type: 'widget', widget: 'blink_box', attributes: {'class': 'box9'}},
      {name: 'Caja 10 Estrella verde', type: 'widget', widget: 'blink_box', attributes: {'class': 'box10'}},
      {name: 'Caja 11 Verde Biologia', type: 'widget', widget: 'blink_box', attributes: {'class': 'box11'}},
      {name: 'Caja 12 Estrella naranja', type: 'widget', widget: 'blink_box', attributes: {'class': 'box12'}},
      {name: 'Caja 13 Bloc de notas', type: 'widget', widget: 'blink_box', attributes: {'class': 'box13'}},
      {name: 'Caja 14 Actividades', type: 'widget', widget: 'blink_box', attributes: {'class': 'box14'}},
      {name: 'Caja 15 Fondo verde con sombra', type: 'widget', widget: 'blink_box', attributes: {'class': 'box15'}},
      {name: 'Caja 16 Fondo azul con sombra', type: 'widget', widget: 'blink_box', attributes: {'class': 'box16'}},
      {name: 'Caja 17 Interrogación', type: 'widget', widget: 'blink_box', attributes: {'class': 'box17'}},
      {name: 'Caja 18 Título y borde color auto', type: 'widget', widget: 'blink_box', attributes: {'class': 'box18'}},
      {name: 'Caja 19 Estrella marron', type: 'widget', widget: 'blink_box', attributes: {'class': 'box19'}},
      {name: 'Caja 20 Redondeada Naranaja', type: 'widget', widget: 'blink_box', attributes: {'class': 'box20'}},
      {name: 'Caja 21 Fondo celeste', type: 'widget', widget: 'blink_box', attributes: {'class': 'box21'}},
      {name: 'Caja 22 Fondo naranja claro', type: 'widget', widget: 'blink_box', attributes: {'class': 'box22'}},
      {name: 'Caja 23 Gramática 1', type: 'widget', widget: 'blink_box', attributes: {'class': 'box23'}},
      {name: 'Caja 24 Gramática 2', type: 'widget', widget: 'blink_box', attributes: {'class': 'box24'}},
      {name: 'Caja 25 Icono cuaderno azul', type: 'widget', widget: 'blink_box', attributes: {'class': 'box25'}},
      {name: 'Caja 26 Redondeada Morada', type: 'widget', widget: 'blink_box', attributes: {'class': 'box26'}},
      {name: 'Caja 27 Fondo y borde azul con sombra', type: 'widget', widget: 'blink_box', attributes: {'class': 'box27'}},
      {name: 'Caja 28 Fondo y borde granate con sombra', type: 'widget', widget: 'blink_box', attributes: {'class': 'box28'}},
      {name: 'Caja 29 Latín y Cultura 1', type: 'widget', widget: 'blink_box', attributes: {'class': 'box29'}},
      {name: 'Caja 30 Latín y Cultura 2', type: 'widget', widget: 'blink_box', attributes: {'class': 'box30'}},
      {name: 'Caja 31 Imagen Redondeada', type: 'widget', widget: 'blink_box', attributes: {'class': 'box31'}},
      {name: 'Caja 32 Imagen CUADRADA', type: 'widget', widget: 'blink_box', attributes: {'class': 'box32'}},
      {name: 'Caja 33 Imagen Color Fondo', type: 'widget', widget: 'blink_box', attributes: {'class': 'box33'}},
